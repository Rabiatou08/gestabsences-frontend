...
const EMPTY = { nom: '', prenom: '', sexe: 'M', code_filiere: '' };
...
export default function Etudiants() {
  ...
  function validate() {
    ...
    if (!form.prenom.trim()) e.prenom       = 'Prenom obligatoire';
    if (!form.code_filiere)  e.code_filiere = 'Filiere obligatoire';
    setErrors(e);
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (editId) {
        ...
        await etudiantsAPI.create(body);
        toast('Etudiant inscrit ✓');
      }
  ...
  async function handleDelete() {
    try {
      ...
      toast('Etudiant supprime', 'danger');
    ...
    <>
      <div className="page-header">
        <div className="page-header-top">
          <h1 className="page-title" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <GraduationCap size={20} color="var(--accent)" /> Etudiants
          </h1>
      ...
      <div className="page-body">
        ...
        <div className="stats-row" style={{ gridTemplateColumns: '1fr 1fr 1fr' }}>
          <div className="stat-card">
            <div className="stat-label">Total etudiants</div>
            <div className="stat-value">{data.length}</div>
          </div>
          <div className="stat-card">
            <div className="stat-label">Garcons</div>
        ...
        {showForm && (
          <div className="card">
            <div className="card-title">
              <Save size={15} />
              {editId ? "Modifier l'etudiant" : 'Inscrire un etudiant'}
            </div>
            ...
            {!editId && (
              <div style={{
                ...
                Un compte de connexion sera cree automatiquement.
                Cliquez sur Recu apres inscription pour imprimer les identifiants.
              </div>
            )}
            ...
            <div className="btn-row">
              ...
              <button className="btn btn-primary" onClick={handleSubmit}>
                <Save size={14} /> {editId ? 'Mettre a jour' : 'Inscrire'}
              </button>
            </div>
          </div>
        )}
        ...
        <div className="card">
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
            <div className="card-title" style={{ marginBottom: 0 }}>
              <GraduationCap size={15} /> Liste des etudiants
            </div>
            {!showForm && (
      ...
      {toDelete && (
        <ConfirmDialog
          ...
          message="Cet etudiant et son compte seront supprimes definitivement."
